...
inline QHash<QString, UIThemeColor> defaultUIThemeColors()
{
    return {
        ...
        {u"ProgressBar.SelectedBackground"_s, {QColor(0x89, 0xb4, 0xfa, 30), QColor(0x89, 0xb4, 0xfa, 30)}},
        {u"ProgressBar.HoverBackground"_s, {QColor(0x31, 0x32, 0x44, 100), QColor(0x31, 0x32, 0x44, 100)}},
        {u"ProgressBar.Groove"_s, {QColor(0x11, 0x11, 0x1b), QColor(0x11, 0x11, 0x1b)}},
        {u"ProgressBar.Text"_s, {QColor(0xcd, 0xd6, 0xf4), QColor(0xcd, 0xd6, 0xf4)}},
        {u"ProgressBar.TextDisabled"_s, {QColor(0x6c, 0x70, 0x86), QColor(0x6c, 0x70, 0x86)}},
        {u"ProgressBar.Focus"_s, {QColor(0x89, 0xb4, 0xfa), QColor(0x89, 0xb4, 0xfa)}},
        {u"ProgressBar.Shimmer"_s, {QColor(0xcd, 0xd6, 0xf4), QColor(0xcd, 0xd6, 0xf4)}},
        {u"ProgressBar.Downloading.Light"_s, {QColor(0x7c, 0xd8, 0x76), QColor(0x7c, 0xd8, 0x76)}},
        {u"ProgressBar.Downloading.Base"_s, {QColor(0x60, 0xc4, 0x5a), QColor(0x60, 0xc4, 0x5a)}},
        {u"ProgressBar.Downloading.Dark"_s, {QColor(0x48, 0xb0, 0x42), QColor(0x48, 0xb0, 0x42)}},
        {u"ProgressBar.Downloading.Shadow"_s, {QColor(0x40, 0xa8, 0x3a), QColor(0x40, 0xa8, 0x3a)}},
        {u"ProgressBar.Completed.Light"_s, {QColor(0xb8, 0xf0, 0xb0), QColor(0xb8, 0xf0, 0xb0)}},
        {u"ProgressBar.Completed.Base"_s, {QColor(0xa6, 0xe3, 0xa1), QColor(0xa6, 0xe3, 0xa1)}},
        {u"ProgressBar.Completed.Dark"_s, {QColor(0x80, 0xd0, 0x7a), QColor(0x80, 0xd0, 0x7a)}},
        {u"ProgressBar.Completed.Shadow"_s, {QColor(0x7c, 0xc4, 0x78), QColor(0x7c, 0xc4, 0x78)}},
        {u"ProgressBar.Stopped.Light"_s, {QColor(0x6c, 0x70, 0x86), QColor(0x6c, 0x70, 0x86)}},
        {u"ProgressBar.Stopped.Base"_s, {QColor(0x58, 0x5b, 0x70), QColor(0x58, 0x5b, 0x70)}},
        {u"ProgressBar.Stopped.Dark"_s, {QColor(0x45, 0x47, 0x5a), QColor(0x45, 0x47, 0x5a)}},
        {u"ProgressBar.Stopped.Shadow"_s, {QColor(0x58, 0x5b, 0x70), QColor(0x58, 0x5b, 0x70)}},
